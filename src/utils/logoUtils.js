...
class LogoUtils {
  ...
  getStockCompanyInfo(symbol) {
    const companyInfo = {
      ...
      // Additional missing companies from Ferrari trading system
      ...
      'NOW': { name: 'ServiceNow', sector: 'Technology', business: 'Workflow Automation' },
      'WDAY': { name: 'Workday', sector: 'Technology', business: 'HR Software' },
      'TEAM': { name: 'Atlassian', sector: 'Technology', business: 'Collaboration Software' },
      'SPLK': { name: 'Splunk', sector: 'Technology', business: 'Data Analytics' },
      'MDB': { name: 'MongoDB', sector: 'Technology', business: 'Database Software' },
      'NET': { name: 'Cloudflare', sector: 'Technology', business: 'Web Security' },
      'DDOG': { name: 'Datadog', sector: 'Technology', business: 'Monitoring Platform' },
      'JD': { name: 'JD.com', sector: 'E-commerce', business: 'Online Retail' },
      'PDD': { name: 'Pinduoduo', sector: 'E-commerce', business: 'Social Commerce' },
